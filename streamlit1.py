...
st.sidebar.markdown("""[Miuul - Website](http://miuul.com)""")

# st.markdown("*Phoenix data* is **best group** ***in Miuul bootcamp***.")
# st.markdown('''
#     :red[Phoenix Data] :orange[katilimcilarinin] :green[hepsi] :blue[cok guzel] :violet[projeler]
#     :gray[yapacak] :rainbow[bu donem].''')
# st.markdown("Bu cicekler de kadin katilimcilarimiz icin  &mdash;\
...
if selected_language == "English":
    ...
    if page == "How to Use / Nasıl Kullanılır":
        ...
        df = functions.txtToDf("/Users/yunusemreturkoglu/Desktop/BootCamp/whatsapp/Phoenix_Data.txt", "Format1")
